...
class wp_option_text extends wp_option {
	...
	function render() {
		$field_html = '<input type="text" name="' . $this->name . '" value="' . htmlentities($this->value, ENT_COMPAT, 'UTF-8') . '" id="' . $this->name . '" ' . $this->get_custom_attrs() . ' />';
...
class wp_option_colorpicker extends wp_option_text {
	...
	function render() {
		$field_html = '<input type="text" name="' . $this->name . '" value="' . htmlentities($this->value, ENT_COMPAT, 'UTF-8') . '" id="' . $this->name . '" ' . $this->get_custom_attrs() . ' /><div class="farbtastic-colorpicker" data-link="' . $this->name . '"></div>';
		return wp_option::render($field_html);
	}
}
?>